...
const projects = [
  {
    ...
    description: "A full-stack e-commerce solution built with React, Node.js, and MongoDB. Features include user authentication, product management, and secure payment integration.",
  ...
  },
  {
    ...
    description: "An intelligent chatbot platform that uses natural language processing to provide automated customer support.",
